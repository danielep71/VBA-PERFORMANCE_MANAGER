...
> **REVISION 15 — 30 August 2026**
>
> **Supersedes:** Revision 14.
>
...
> table said Phase 6 was complete; the two are reconciled here. Wiki corrections
> `eb1e77a` fixed five stale harness-evidence claims the Phase 6 sweep missed,
> including a `Core-API` note contradicting its own signature table.
>
...
> **Status:** Phases 0–6 complete; exact-SHA certification, merge, tag and provenance remain
>
...
| Wiki promotion | `dd438f8` canonical promotion (11 pages) · `2d5a13d` suite counts scoped as a candidate snapshot · `eb1e77a` five stale harness-evidence claims corrected |
...
| Behavior/API change | Required same-commit `[Unreleased]` entry | Revision 14 status |
|---|---|---|
...
| Issue | Minimum closure evidence | State at Revision 14 |
|---|---|---|
...
## Appendix A — Revision 14 live open-issue reconciliation
