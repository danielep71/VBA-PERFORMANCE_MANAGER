...
> **REVISION 21 — 31 August 2026**
>
> **Supersedes:** Revision 20.
>
...
| Live issue snapshot | #36 corrected; #45 and #46 created `2026-08-31` |
| Open portfolio distribution | **19 total** · v1.4.0: **0** · v1.4.1: **12** · v1.5.0: **7** |
| Open-issue assignment | All 19 assigned to `danielep71` |
| Audit disposition | #36 retains five live contradictions; #45 owns compile-safety linting; #46 owns label-sync robustness and the Node 24 action runtime |
...
| `fix(measurement): enforce requested-backend integrity` | #23 + #27 start validation, worker-raise evidence, baseline outputs, behavioral correction and distinct `Added` entry | **Complete** — `e5031fc`, `e7ab62d`, wiki `052f903`/`f5ee791` |
...
| Issue | Minimum closure evidence | State at Revision 18 |
|---|---|---|
...
| [#27](https://github.com/danielep71/VBA-PERFORMANCE_MANAGER/issues/27) | Forwarded three-output evidence, worker-raise boundary, clean/partial/fallback/all-failed baseline regressions and distinct same-commit `Added` entry | **Closed** |
