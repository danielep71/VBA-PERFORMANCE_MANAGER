...
> **REVISION 11 — 30 August 2026**
>
> **Supersedes:** Revision 10.
>
> **Revision 11 correction:** #2 is genuinely closed. `e8eae90` now asserts
> `ERR_CPM_QPC_READ_FAILED` exactly on both strict QPC start-failure paths,
> including the aligned path delivered in `eff392f`. The certified exact-SHA
> run records 78 cases, 597 assertions and zero failures; all 12 static checks
> pass. The issue body and this plan now match the closed GitHub record.
>
...
> **Status:** Phases 0–3A delivered; begin Phase 4 with #28
>
...
| Live issue snapshot | #2 closure verified `2026-08-30` |
| Open portfolio distribution | **19 total** · v1.4.0: **3** · v1.4.1: **9** · v1.5.0: **7** |
| Open-issue assignment | All 19 assigned to `danielep71` |
| Audit disposition | #2 closed as completed; the remaining open issues remain valid and correctly scheduled |
...
| Delivered implementation head | `e8eae9090ca6d0a207d5585f8daa816d89ff34c0` |
| Delivered so far | #26 (`6d44f2f`, `9362b8f`, `9064cff`) · #25 (`37c64fc`, manual dispatch PASS) · #23/#27 (`e5031fc`, `e7ab62d`) · #2 (`eff392f`, `e8eae90`) |
| Current Excel regression | `e8eae90` · 78 cases · 597 assertions · 0 failures · Microsoft 365 Excel 64-bit Version 2607 Build 16.0.20228.20188 |
...
| Behavior/API change | Required same-commit `[Unreleased]` entry | Revision 11 status |
|---|---|---|
...
| `test(measurement): split worker fault injection` | #28 start/endpoint seams, overhead three-output evidence, separate count semantics, cleanup tests and same-commit `Added` entry | **Next** — Phase 4 |
...
| Issue | Minimum closure evidence | State at Revision 11 |
|---|---|---|
...
## Appendix A — Revision 11 live open-issue reconciliation
...
snapshot below predates `eff392f` and the Revision 11 verification; current
...
> Revision 11's milestone register, Appendix A and live GitHub records are
