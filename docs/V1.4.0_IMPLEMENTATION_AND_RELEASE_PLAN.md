...
> **REVISION 8 — 30 August 2026**
>
> **Supersedes:** Revision 7.
>
> **Revision 8 correction:** the complete 19-issue open backlog was reconciled
> against current source, documentation, repository configuration and live
> GitHub metadata. Every open issue remains valid, is assigned to `danielep71`
> and is attached to the correct milestone. No issue was closed or moved.
> Targeted title, label, priority, sequencing and body corrections are recorded
> in Appendix A; the v1.4.0 execution order is unchanged.
>
...
| Open portfolio distribution | **19 total** · v1.4.0: **4** · v1.4.1: **8** · v1.5.0: **7** |
...
| Behavior/API change | Required same-commit `[Unreleased]` entry | Revision 8 status |
|---|---|---|
...
| Issue | Minimum closure evidence | State at Revision 8 |
|---|---|---|
...
## Appendix A — Revision 8 live open-issue reconciliation

The 30 August 2026 audit re-read all 19 open issues against the current branch,
...
in v1.4.0, eight in v1.4.1 and seven in v1.5.0. All are assigned to
`danielep71`.
...
- #11 and #24–#43 are assigned to `danielep71`; #2 was already assigned.
...
> Revision 8's milestone register, Appendix A and live GitHub records are
