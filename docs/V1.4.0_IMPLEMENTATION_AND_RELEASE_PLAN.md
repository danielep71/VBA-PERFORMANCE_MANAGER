...
> **REVISION 20 — 31 August 2026**
>
> **Supersedes:** Revision 19.
>
...
>
> **Current scope:** #11, #29 and #44 are deferred to v1.4.1. v1.4.0 retains
...
| Live issue snapshot | #29 reopened and moved `2026-08-31` |
| Open portfolio distribution | **17 total** · v1.4.0: **0** · v1.4.1: **10** · v1.5.0: **7** |
| Open-issue assignment | All 17 assigned to `danielep71` |
| Audit disposition | #29 reopened because the prior evidence-free `completed` closure was invalid; title, labels and assignment preserved |
| v1.4.0 milestone | GitHub milestone `#3` |
| Open v1.4.0 issues | **0** |
| Closed v1.4.0 issues | **7**: #2, #23, #24, #25, #26, #27 and #28 |
| Explicitly deferred | #11, #29 and #44 → v1.4.1 milestone `#4` |
...
- The v1.4.1 automation/runtime/testability issues #11, #30–#36 and #44.
...
## Appendix A — Revision 18 live open-issue reconciliation

The 31 August 2026 reconciliation incorporates #29's evidence-based reopening
and milestone move. Seventeen issues remain open and scheduled: none in v1.4.0,
ten in v1.4.1 and seven in v1.5.0. All 17 are assigned to `danielep71`.
...
- #36 now carries `CI` and includes the stale bug-report-template statement as
  the fifth live contract contradiction.
...
- #44 now owns deterministic alignment-loop read-failure and timeout coverage
  ...
  #2 or v1.4.0.
- #11 and #24–#44 are assigned to `danielep71`; closed #2 and #24 remain assigned for
...
| [#36](https://github.com/danielep71/VBA-PERFORMANCE_MANAGER/issues/36) — Reconcile remaining source, repository, and CI contract contradictions | v1.4.1 | `bug` `documentation` `CI` `P3` | Valid; five confirmed contradictions remain |
