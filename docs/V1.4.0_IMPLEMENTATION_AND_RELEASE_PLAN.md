...
> **REVISION 18 — 31 August 2026**
>
> **Supersedes:** Revision 17.
>
...
>
> The annotated `v1.4.0` tag currently resolves to
> `a5390b4c6ca56ebbd87eca121b5167ee5dc09963`. The retained 64-bit execution
> artifact identifies `5a4d57bbf28124526660ef727a6509386901440d`, so it does
> not certify the exact tag target. The class is byte-identical, but the locked
> evidence rule is SHA-based. Exact-tag 64-bit execution remains the release
> evidence action; the tag must not be moved to disguise that mismatch.
>
...
> **Status:** v1.4.0 is tagged at `a5390b4`; #29 is open in v1.4.1; exact-tag 64-bit execution evidence and final provenance/publication verification remain to be reconciled
>
...
| Supplied release-candidate execution | `5a4d57b` · 80 cases · 643 assertions · 0 failures · 64-bit; does **not** match tag target `a5390b4` |
...
- [ ] Integrated regression passes in real 64-bit Excel against exact tag target `a5390b4`.
- [x] v1.4.0 makes no Office 32-bit execution-certification claim; #29 carries that unverified assurance surface into v1.4.1.
- [ ] The exact-tag 64-bit run emits the frozen machine-readable result schema.
- [ ] Static checks, workbook, tag, manifest and release evidence all bind to exact tag target `a5390b4`.
