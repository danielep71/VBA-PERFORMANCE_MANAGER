...
| Delivered so far | #26 (`6d44f2f`, `9064cff`) · #25 (`37c64fc`, manual dispatch evidence PASS) |
| Suite at #25 | 73 cases · 522 assertions · 0 failures |
...
|---:|---|---|---|
| 1 | [#26](https://github.com/danielep71/VBA-PERFORMANCE_MANAGER/issues/26) — Correct enum type-safety claims to reflect VBA Long semantics | `bug` `documentation` `P2` `api` | **Closed** — `6d44f2f`, `9064cff` |
