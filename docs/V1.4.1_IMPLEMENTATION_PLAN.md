...
> **REVISION 2 — 31 August 2026**
>
> **Status:** Active planning baseline.
>
> **Source baseline:** `83300d8ff00b3856327a2015bab87e2cbf802601`
> on `main`.
>
...
| Active issues | **15**: #11, #29–#36, #44–#47, #49–#50 |
| Open portfolio distribution | **23 total** · v1.4.1: **15** · v1.5.0: **8** |
| Assignment | All 15 assigned to `danielep71` |
...
```mermaid
flowchart TD
    A["#49 release ledger"] --> B["#36 documentation truth"]
    J["#34 support policy"] --> B
    B --> C["#50 release-state checks"]
    C --> D["#45 compile-safety gate"]
    D --> E["Runtime and TW corrections"]
    F["#44 alignment seams"] --> G["#31 timer-period rollback"]
    E --> H["#11 runner core"]
    G --> H
    B --> I["#47 final demo rebuild"]
    H --> I
    I --> K["Final 64-bit certification"]
    K --> L["#29 32-bit if available"]
```
...
### 0B. Settle support and reconcile current release truth — #34, #36
...
### 0C. Enforce the corrected release-state baseline — #50
...
| #11, #45, #46, #50 | No runtime/API entry; document assurance/CI changes in release notes as appropriate |
...
- [ ] #30–#36, #44–#47 and #49–#50 are closed with direct evidence
