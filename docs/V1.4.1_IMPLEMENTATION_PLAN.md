...
| Full issue inventory | **48 total** · **24 open** · **24 closed** |
| Open portfolio distribution | v1.4.1: **16** · v1.5.0: **8** |
| Closed portfolio distribution | v1.2.0: **4** · v1.3.0: **11** · v1.4.0: **7** · no milestone: **1** (#22, `not planned`) |
| Assignment | All 47 substantive issues assigned to `danielep71`; #22 intentionally unassigned |
