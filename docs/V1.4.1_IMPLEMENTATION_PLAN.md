...
| Active issues | **14**: #11, #29–#36, #44–#47, #50 |
| Full issue inventory | **47 total** · **22 open** · **25 closed** |
| Open portfolio distribution | v1.4.1: **14** · v1.5.0: **8** |
| Closed portfolio distribution | v1.2.0: **4** · v1.3.0: **11** · v1.4.0: **7** · v1.4.1: **2** (#49, #51) · no milestone: **1** (#22, `not planned`) |
...
[issue-36-reconciliation.patch](wiki-pending/issue-36-reconciliation.patch),
...
| 2 | [#36 — Reconcile v1.4.0 post-release source, repository, and wiki contradictions](https://github.com/danielep71/VBA-PERFORMANCE_MANAGER/issues/36) | `bug` `documentation` `P1` `release` | Source comments, contact configuration and all four repository-document criteria reconciled from `9fa0d738`; ten wiki content pages plus two link repairs prepared and retained as a patch; publication remains blocked |
...
| Implemented; open | [#45 — Add compile-safety checks for error labels and undeclared assignments](https://github.com/danielep71/VBA-PERFORMANCE_MANAGER/issues/45) | `enhancement` `CI` `P2` `testing` | Two separately reported checks; 41 fixtures, three CLI scenarios, 15-check gate; wiki count synchronization blocked; implementation retained on `v1.4.1`, #61 closed unmerged |
...
- Core API, diagnostics, FAQ, Home, installation, limitations, statistics,
  ...
  retained wiki patch, with two additional badge-anchor repairs. Publish and
  verify that patch before completing #36; local validation is not publication.
