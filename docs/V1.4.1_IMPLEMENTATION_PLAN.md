...
| Active issues | **13**: #11, #29–#36, #44, #46, #47, #50 |
| Full issue inventory | **47 total** · **21 open** · **26 closed** |
| Open portfolio distribution | v1.4.1: **13** · v1.5.0: **8** |
| Closed portfolio distribution | v1.2.0: **4** · v1.3.0: **11** · v1.4.0: **7** · v1.4.1: **3** (#45, #49, #51) · no milestone: **1** (#22, `not planned`) |
...
| 2 | [#36 — Reconcile v1.4.0 post-release source, repository, and wiki contradictions](https://github.com/danielep71/VBA-PERFORMANCE_MANAGER/issues/36) | `bug` `documentation` `P1` `release` | Repository criteria complete; wiki content published at `f18fd82` and matches the prepared tree. Remains open for 15 rendered heading links across ten pages; replacement files prepared |
...
- Core API, diagnostics, FAQ, Home, installation, limitations, statistics,
  ...
  Content publication is verified. Correct the 15 remaining emoji heading links
  found in rendered HTML and re-verify before completing #36.
