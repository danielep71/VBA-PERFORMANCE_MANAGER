...
| Plan location | Canonical on `main`; mirrored on the working branch; frozen under `docs/releases/` at release |
| Working branch | `v1.4.1`, based on `abee10b6` |
| Pull-request publication | Revision 7 and working-branch changes require the normal protected-main pull request; #56 remains closed unmerged |
...
The working branch is published through existing PR #61. Canonical `main`
synchronization still requires its normal protected merge. The wiki correction
...
workflow, published tag, binary or archived plan is changed. Revision 7 must be
reviewed and merged to `main` through the existing protected workflow; branch
publication alone does not update the canonical plan.
